...
const YoutubeIframe = (props, ref) => {
  ...
  (0, _react.useImperativeHandle)(ref, () => ({
    ...
    playVideo: () => {
      webViewRef.current.injectJavaScript(_PlayerScripts.PLAYER_FUNCTIONS.playVideoScript);
    },
    pauseVideo: () => {
      webViewRef.current.injectJavaScript(_PlayerScripts.PLAYER_FUNCTIONS.pauseVideoScript);
    },
    stopVideo: () => {
      webViewRef.current.injectJavaScript(_PlayerScripts.PLAYER_FUNCTIONS.stopVideoScript);
    },
    getPlaybackRate: () => {
  ...
  console.log('i am inside the webview | yt iframe packg');
