...
`,
  playVideoScript: `
window.ReactNativeWebView.postMessage(JSON.stringify({eventType: 'playVideo', data: player.playVideo()}));
true;
`,
  pauseVideoScript: `
window.ReactNativeWebView.postMessage(JSON.stringify({eventType: 'pauseVideo', data: player.pauseVideo()}));
true;
`,
  stopVideoScript: `
window.ReactNativeWebView.postMessage(JSON.stringify({eventType: 'stopVideo', data: player.stopVideo()}));
true;
`,
  getVolumeScript: `
